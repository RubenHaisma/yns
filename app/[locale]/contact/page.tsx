            ...
            <div className="max-w-3xl mx-auto px-2 sm:px-4 lg:px-6">
              ...
              >
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="inline-flex items-center space-x-3 bg-gradient-to-r from-green-500/10 to-orange-500/10 rounded-full px-8 py-4 border border-green-200/50 mb-8"
                >
              ...
              >
                ...
                <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 overflow-hidden">
                  ...
                  <div className="absolute inset-0 opacity-5">
                    ...
                    <motion.div
                      className="absolute top-8 right-8 w-20 h-20 border border-orange-300/30 rounded-full"
                      animate={{ rotate: 360 }}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div className="grid md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-2xl text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-4 focus:ring-green-400/30 focus:border-green-400 transition-all duration-300 text-base font-medium"
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleInputChange}
                          className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-2xl text-gray-800 focus:outline-none focus:ring-4 focus:ring-green-400/30 focus:border-green-400 transition-all duration-300 text-base font-medium"
                        >
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={handleInputChange}
                          className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-2xl text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-4 focus:ring-green-400/30 focus:border-green-400 transition-all duration-300 text-base font-medium resize-none"
                      ...
                      <motion.button
                        type="submit"
                        className="w-full bg-gradient-to-r from-green-500 to-green-600 text-white py-4 px-6 rounded-2xl font-bold text-lg hover:from-green-600 hover:to-green-700 transition-all duration-300 shadow-xl hover:shadow-2xl flex items-center justify-center space-x-4"
